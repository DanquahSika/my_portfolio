    ...
    <div className="block sm:flex gap-0 sm:gap-10 mt-14">
      <div className="w-full sm:w-1/3 text-left">
        ...
        <div className="mb-7">
          ...
          <p className="font-general-regular text-primary-dark text-ternary-light">
            ...
            {singleProjectData.ProjectInfo.SocialSharing.map((social) => {
              return (
                <a
                  ...
                  className="bg-ternary-light bg-ternary-dark text-gray-400 hover:text-primary-dark hover:text-primary-light p-2 rounded-lg shadow-sm duration-500"
                >
      ...
      <div className="w-full sm:w-2/3 text-left mt-10 sm:mt-0">
        <p className="font-general-regular text-primary-dark text-primary-light text-2xl font-bold mb-7">
