  ...
  const [messages, setMessages] = useState([
    {
      id: 1,
      sender: "Linda Quaye",
      message: "Hello, how much is it for a website?",
    },
    {
      id: 2,
      sender: "Cassandra Mensah",
      message: "Please what is your delivery time?",
    },
  ...
  return (
    ...
    >
      ...
      <div className="col-span-1">
        <div className="bg-white p-4 border border-gray-200 rounded-lg shadow hover:shadow-lg transition duration-300">
          <h2 className="text-xl font-bold mb-4 text-black">Messages</h2>
